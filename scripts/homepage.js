window.addEventListener("load",event=>{
    ...
    home.onclick= event=>{
        ...
        const listUrl = new URL('http://localhost/info2180FinalProject/scripts/homepage.php');
        let params = {btn: "all"};
    ...
    setInterval( ()=>{
        ...
        if (document.contains(homecreatebtn)){
            ...
            filtersupport.onclick =(event)=>{
                filterurl = new URL('http://localhost/info2180FinalProject/scripts/homepage.php');
